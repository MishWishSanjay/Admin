# Angular8 and Bootstrap 4

Simple Dashboard Admin App built using Angular 8 and Bootstrap 4

This project is a port of the famous Free Admin Bootstrap Theme [v8.0](http://startbootstrap.com/template-overviews/sb-admin-2/) to Angular8 Theme.
